...
function ProgramList() {
  ...
  const groupedPrograms = useMemo(() => {
    ...
    // Sort groups by key (so chapters are in order: Chapter 01, Chapter 02, etc.)
    const sortedGroups = {}
    ...
    <div className="program-list">
      ...
      <div className="header-container">
        <div className="header-content">
          <h1 className="main-title">K&R C Programming Language</h1>
          <p className="subtitle">
            The C Programming Language (2nd Edition) - Kernighan & Ritchie Solutions
          </p>
          <div className="header-links">
            <a
              href="https://www.amazon.com/Programming-Language-2nd-Brian-Kernighan/dp/0131103628"
              target="_blank"
            ...
            <a
              href="https://github.com/ohho/the-c-programming-language-2nd-edition-solutions"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className="footer">
        <p>
          Powered by <strong>Wandbox API</strong> - Compile and run C code online
        </p>
        <p>
          K&R C Programming exercises compiled with GCC in your browser
        </p>
      </div>
    </div>
  )
